...
public class JogoMemoria3 extends AppCompatActivity {

    private final long idJogoMemoria = 9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jogo_memoria3);
    ...
    private void carregarCartas() {
        ...
        for (int i = 0; i < cards.size(); i++) {
            ...
            int size = 125; // ou calcule dinamicamente
            GridLayout.LayoutParams params = new GridLayout.LayoutParams();
            params.width = size;
            params.height = size;
            params.setMargins(8, 16, 16, 16);
