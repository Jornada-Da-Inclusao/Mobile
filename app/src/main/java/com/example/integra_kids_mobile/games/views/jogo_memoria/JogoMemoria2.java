...
public class JogoMemoria2 extends AppCompatActivity {

    private final long idJogoMemoria = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jogo_memoria2);
        ...
        timer.setTimerListener(new Timer.TimerListener() {
            ...
            public void onTimeFinished() {
                ...
                int corTema = ContextCompat.getColor(JogoMemoria2.this, R.color.red);
                GameResultDialog.mostrarModalFeedback(JogoMemoria2.this, false, corTema);
            }
        });
    ...
    private void carregarCartas() {
        ...
        for (int i = 0; i < cards.size(); i++) {
            ...
            int size = 130; // ou calcule dinamicamente
            GridLayout.LayoutParams params = new GridLayout.LayoutParams();
            params.width = size;
            params.height = size;
            params.setMargins(8, 36, 16, 36);
